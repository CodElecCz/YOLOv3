...
local_layer parse_local(list *options, size_params params)
{
    ...
    char *activation_s = option_find_str(options, "activation", (char*)"logistic");
...
{
    char *type_s = option_find_str(options, "type", (char*)"sse");
...
layer parse_shortcut(list *options, size_params params, network *net)
{
    ...
    char *activation_s = option_find_str(options, "activation", (char*)"linear");
    ACTIVATION activation = get_activation(activation_s);
