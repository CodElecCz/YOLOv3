...
void train_classifier(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    char *label_list = option_find_str(options, "labels", (char*)"data/labels.list");
    char *train_list = option_find_str(options, "train", (char*)"data/train.list");
...
void validate_classifier_crop(char *datacfg, char *filename, char *weightfile)
{
    ...
    char *label_list = option_find_str(options, "labels", (char*)"data/labels.list");
    char *valid_list = option_find_str(options, "valid", (char*)"data/train.list");
    int classes = option_find_int(options, "classes", 2);
...
void validate_classifier_10(char *datacfg, char *filename, char *weightfile)
{
    ...
    for(i = 0; i < m; ++i){
        ...
        free(pred);
        if(indexes[0] == iclass) avg_acc += 1;
        for(j = 0; j < topk; ++j){
            if(indexes[j] == iclass) avg_topk += 1;
        }
...
void try_classifier(char *datacfg, char *cfgfile, char *weightfile, char *filename, int layer_num)
{
    ...
    if(!name_list) name_list = option_find_str(options, "labels", (char*)"data/labels.list");
...
void label_classifier(char *datacfg, char *filename, char *weightfile)
{
    ...
    char *label_list = option_find_str(options, "names", (char*)"data/labels.list");
    char *test_list = option_find_str(options, "test", (char*)"data/train.list");
    int classes = option_find_int(options, "classes", 2);
...
void csv_classifier(char *datacfg, char *cfgfile, char *weightfile)
{
    ...
    char *test_list = option_find_str(options, "test", (char*)"data/test.list");
    int top = option_find_int(options, "top", 1);
