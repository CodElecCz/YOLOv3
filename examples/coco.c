...
void test_coco(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        draw_detections(im, dets, l.side*l.side*l.n, thresh, (char**)coco_classes, alphabet, 80);
...
void run_coco(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, cam_index, filename, (char**)coco_classes, 80, frame_skip, prefix, avg, .5, 0,0,0,0);
}
